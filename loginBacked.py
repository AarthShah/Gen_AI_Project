...
def add_user(user,pas):
    try :
        with open("C:\\Users\\Aarth Shah\\OneDrive\\Desktop\\Sunbeam\\project\\Gen_AI_Project\\AppData\\users.csv","a",newline='') as f:
            writer=csv.writer(f)
...
def check_password(username, password):
   try: 
        pass_df=pd.read_csv("C:\\Users\\Aarth Shah\\OneDrive\\Desktop\\Sunbeam\\project\\Gen_AI_Project\\AppData\\users.csv")
